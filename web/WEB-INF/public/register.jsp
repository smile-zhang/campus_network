        ...
        <form action="/user/doRegist" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select size="4" onchange="changeStatus(this);" name="identity">
                ...
                <tr class="gra_spe">
                    ...
                    <td>
                        ...
                        <input id="university" onclick="showUniTbl();" type="text" name="school"/>
                    </td>
                    <td></td>
                </tr>
                <!-- 考虑大学生要输入的特别信息 end -->
                ...
                <tr>
                    <td></td>
                    <td><input type="checkbox" name="??"/><span class="font3">&nbsp;我已阅读并同意遵守</span> <a
                            href="#">校内网服务条款</a></td>
                    <td></td>
                </tr>
            </table>
                            ...
                            <td>
                                <li>
                                    <a onclick='showMyUni(this)' href="javascript:void(0);"
                                       class="xh" id="${university.id }">${university.name }</a></li>
                            </td>
                            <c:if test="${vs.count%3==0}"></tr>
                        <tr></c:if>
                            </c:forEach>
                        </tr>
