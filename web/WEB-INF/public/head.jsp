<%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
   ...
   <div class="head1">
   <img class="img1" src="/images/front/top1.gif" />
   <img class="img2" src="/images/front/top2.jpg" />
   <img src="/images/front/xnw3.jpg" style="float: left;"/>
   <ul class="navi1">
   <li onmouseover="changeBG(this)" onmouseout="changeBG2(this)"><a class="anavi" href="/register.do?flag=regUI">注册</a></li>
